...
/// Adds pattern-matching-related methods to [ResponseWrapperList].
extension ResponseWrapperListPatterns<T> on ResponseWrapperList<T> {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ResponseWrapperList<T> value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ResponseWrapperList() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
